if (
    ((App.homeSlider = (e) => {
                ...
                init: () => {
                    setTimeout(() => {
                        for (const t of document.querySelectorAll(
                            `${e} .swiper-slide-active .animated`
                        ))
                            t.classList.add(
                                "visible",
        ...
        t.on("slideChange", () => {
            for (const t of document.querySelectorAll(`${e} .animated`))
                t.classList.remove("visible", t.getAttribute("data-animate"));
            for (const e of t.slides[t.activeIndex].querySelectorAll(
                ".animated"
            ))
                e.classList.add("visible", e.getAttribute("data-animate"));
        });
    }),
    (App.dealSlider = (e) => {
        new Swiper(e, {
    ...
    (App.atcDemo = () => {
        for (const e of document.querySelectorAll(".atc-demo"))
            e.addEventListener("click", () => {
                const t = e.getAttribute("data-title")
                    ? e.getAttribute("data-title")
                    : e.closest(".card").querySelector(".card-title").innerText;
                new Noty({
                    type: "success",
    ...
    (App.atwDemo = () => {
        for (const e of document.querySelectorAll(".atw-demo"))
            e.addEventListener("click", () => {
                const t = e.getAttribute("data-title")
                        ? e.getAttribute("data-title")
                        : e.closest(".card").querySelector(".card-title")
                              .innerText,
                    i = e.classList.contains("active")
                        ? "removed from"
                        : "added to";
                new Noty({
                    type: "pink",
                    ...
                    e.classList.contains("active")
                        ...
                        : e.setAttribute("title", "Added to wishlist");
            });
    }),
    (App.quickviewDemo = () => {
        ...
        for (const e of document.querySelectorAll(".quickview-demo"))
            e.addEventListener("click", () => {
    ...
    (App.colorOption = () => {
        for (const e of document.querySelectorAll(
            ".card-product .custom-color input"
        ))
    ...
    (App.rating = () => {
        for (const n of document.querySelectorAll(".rating")) {
            ...
            if (void 0 !== o) {
                for (var e = 0; e < Math.floor(o); e++)
                    n.insertAdjacentHTML(
                        "beforeend",
                        '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 32 32"><path d="M32 12.408l-11.056-1.607-4.944-10.018-4.944 10.018-11.056 1.607 8 7.798-1.889 11.011 9.889-5.199 9.889 5.199-1.889-11.011 8-7.798z"></path></svg>\n'
                    );
                o % 1 != 0 &&
                    n.insertAdjacentHTML(
                        "beforeend",
    ...
    for (const e of document.querySelectorAll(".showSigninContent"))
        e.addEventListener("click", (e) => {
            for (const e of signinModal.querySelectorAll(".modal-content"))
